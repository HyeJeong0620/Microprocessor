...
//	  HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_1|GPIO_PIN_0);
//	  HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_15|GPIO_PIN_14);
//	  HAL_Delay(100);

	  HAL_GPIO_TogglePin(GPIOB, GPIO_PIN_15|GPIO_PIN_14|GPIO_PIN_13|GPIO_PIN_12);
	  HAL_Delay(300);
	  HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_3|GPIO_PIN_2|GPIO_PIN_1|GPIO_PIN_0);
