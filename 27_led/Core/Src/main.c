...
int main(void)
{
  ...
  while (1)
  {
	  led_1000 = led_ccr1 / 1000; //1000의 자리
	  led_100 = (led_ccr1 % 1000) / 100; //100의 자리
	  led_10 = ((led_ccr1 % 1000) % 100) / 10; //10의 자리
	  led_1 = ((led_ccr1 % 1000) % 100) % 10; //1의 자리
